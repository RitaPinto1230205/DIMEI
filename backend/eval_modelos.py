...
def compute_metrics(resultado, ground_truth, tok_in, tok_out):
    ...
    sizes = (resultado.get("client_profile") or {}).get("sizes") or {}
...
print("Conversas: " + str(num_conversas) + " | Métricas: 13 (EM, Precision, Recall, F1, Hallucination, Schema, Null, Language, Latency, TokenEff, ParseRate, Actionability, Summary)")
print("="*75)
